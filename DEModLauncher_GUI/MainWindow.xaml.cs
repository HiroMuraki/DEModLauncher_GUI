...
public partial class MainWindow : Window
{
    ...
    {
        DEModManagerViewModelExtensions.TipToOpenResourceFile(GetResourceFrom(sender));
    }
    #endregion
    ...
    {
        var source = e.Data.GetData(typeof(DEModPackViewModel)) as DEModPackViewModel;
        if (source == null)
        {
            return;
        }
        var target = ((FrameworkElement)sender).Tag as DEModPackViewModel;
        if (target == null)
        {
            return;
        }
    ...
    {
        if (((FrameworkElement)sender).Tag is not DEModResourceViewModel target)
        {
            return;
        }
        ...
        // 否则视为资源排序
        if (e.Data.GetData(typeof(DEModResourceViewModel)) is not DEModResourceViewModel source)
        {
            return;
        }
    ...
    private static DEModResourceViewModel GetResourceFrom(object sender)
    {
        return (DEModResourceViewModel)((FrameworkElement)sender).Tag;
    }
    private static DEModPackViewModel GetModPackFrom(object sender)
    {
        return (DEModPackViewModel)((FrameworkElement)sender).Tag;
    }
    #endregion
}
